...
- **Dependency Updates**:
  ...
  - Azure.Storage.Queues: 12.24.0 → 12.25.0
  - Microsoft.Extensions.Hosting.Abstractions: 10.0.0 → 10.0.2
  - Microsoft.Extensions.Logging.Abstractions: 10.0.0 → 10.0.2
  - Microsoft.Extensions.Options: 10.0.0 → 10.0.2
  - Microsoft.Extensions.Options.DataAnnotations: 10.0.0 → 10.0.2
