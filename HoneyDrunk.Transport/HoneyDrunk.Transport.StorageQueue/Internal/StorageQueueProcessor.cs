    ...
    ILogger<StorageQueueProcessor> logger) : ITransportConsumer, IAsyncDisposable
{
    ...
    private static TransportEnvelope DeserializeEnvelope(QueueMessage message)
    {
        ...
        return new TransportEnvelope
        {
            ...
            NodeId = queueEnvelope.NodeId,
            StudioId = queueEnvelope.StudioId,
            TenantId = queueEnvelope.TenantId,
            ProjectId = queueEnvelope.ProjectId,
            Environment = queueEnvelope.Environment,
